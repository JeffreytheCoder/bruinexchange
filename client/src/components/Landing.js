...
import logo from '../images/bruinpass-logo-small.png';
...
const Landing = () => {
  return (
    <div class="flex flex-col h-screen justify-between">
      ...
      <footer class="bg-gray-200 w-full font-main">
        <div class="max-w-screen-xl px-4 py-12 mx-auto space-y-8 overflow-hidden sm:px-6 lg:px-8 justify-center">
          ...
          {/* <p class="mt-8 text-base leading-6 text-center text-gray-400">
            © 2021 BruinPass, Inc. All rights reserved.
          </p> */}
          <div class="flex justify-center">
            <p class="text-base leading-6 text-center text-gray-400 inline-flex mx-auto">
              Built with
              <svg
                fill="#e53e3e"
                viewBox="0 0 24 24"
